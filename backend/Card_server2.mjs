...
// Middleware
app.use(cors({
    origin: 'https://simonchor-website.web.app', // Adjust this if your frontend is running on a different port
}));
app.use(bodyParser.json());
app.use(express.json());

// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://chorchungho:69744796simon@simonchors.vnrl9.mongodb.net/?retryWrites=true&w=majority&appName=simonchors', {
